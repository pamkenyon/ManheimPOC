...
<module external.linked.project.id=":app" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/.." external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="javax.ws.rs:jsr311-api:1.1.1@jar" level="project" />
    <orderEntry type="library" name="xalan:xalan:2.7.2@jar" level="project" />
    ...
    <orderEntry type="library" name="xml-apis:xml-apis:1.3.04@jar" level="project" />
    ...
    <orderEntry type="library" scope="TEST" name="org.nanohttpd:nanohttpd:2.3.1@jar" level="project" />
    <orderEntry type="library" name="xalan:serializer:2.7.2@jar" level="project" />
    ...
    <orderEntry type="library" name="com.android.support.constraint:constraint-layout-1.1.0" level="project" />
    <orderEntry type="library" name="com.android.support:support-v4-25.4.0" level="project" />
    <orderEntry type="library" name="com.android.support.constraint:constraint-layout-solver:1.1.0@jar" level="project" />
    <orderEntry type="library" scope="TEST" name="com.google.code.gson:gson:2.8.2@jar" level="project" />
    ...
    <orderEntry type="library" scope="TEST" name="org.nanohttpd:nanohttpd-webserver:2.3.1@jar" level="project" />
